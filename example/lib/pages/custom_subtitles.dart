...
class CustomNetworkWithSubtitlesPage extends StatefulWidget {
  const CustomNetworkWithSubtitlesPage({Key? key}) : super(key: key);

  @override
  State<CustomNetworkWithSubtitlesPage> createState() =>
      _CustomNetworkWithSubtitlesPageState();
}

class _CustomNetworkWithSubtitlesPageState
    extends State<CustomNetworkWithSubtitlesPage> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: MeeduVideoPlayer(
          ...
          closedCaptionDistanceFromBottom: 80,
          customCaptionView: (context, controller, responsive, text) => Center(
            child: Container(
              color: Colors.black,
              child: Padding(
