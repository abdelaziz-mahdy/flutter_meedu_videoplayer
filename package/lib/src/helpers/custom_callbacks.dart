...
class CustomCallbacks {
  ...
  final void Function(MeeduPlayerController controller)? onLongPressStartedCallback;

  /// Callback for mobile: Triggered when a long press ends, typically used for slowing down the video.
  final void Function(MeeduPlayerController controller)? onLongPressEndedCallback;
  ...
  CustomCallbacks copyWith({
    ...
    return CustomCallbacks(
      onLongPressStartedCallback: onLongPressStartedCallback ?? this.onLongPressStartedCallback,
      onLongPressEndedCallback: onLongPressEndedCallback ?? this.onLongPressEndedCallback,
    );
  }
}
